...
export default function DynamicModule({ modules }) {
  ...
  const headerBottomHeight = useHeaderHeight(
    (state) => state.headerBottomHeight
  );
  ...
  const Module = lazy(() =>
    import(`../modules/${renameModule(activePage)}.jsx`)
  );
  console.log(renameModule(activePage), "mn log shodam");
  return (
    <div
